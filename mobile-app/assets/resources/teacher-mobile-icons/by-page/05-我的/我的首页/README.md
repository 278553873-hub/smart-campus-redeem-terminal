...
这里列出“我的首页”页面及其弹窗、抽屉和复用子组件实际使用的图标。公共图标只在公共目录保存一份。
...
| `../../00-公共图标/file-cog.svg` | 档案设计 | 公共图标 | Lucide SVG |
| `../../00-公共图标/message-circle.svg` | 消息或邀请家长 | 公共图标 | Lucide SVG |
| `more-archive-design.svg` | 更多工具：档案设计 | 本页面 | 页面专用 SVG |
| `more-coin-issuance.svg` | 更多工具：货币发放 | 本页面 | 页面专用 SVG |
| `more-department-management.svg` | 更多工具：部门管理 | 本页面 | 页面专用 SVG |
| `more-questionnaire.svg` | 更多工具：问卷采集 | 本页面 | 页面专用 SVG |
| `more-subject-management.svg` | 更多工具：科目管理 | 本页面 | 页面专用 SVG |
| `more-suggestion-feedback.svg` | 更多工具：建议反馈 | 本页面 | 页面专用 SVG |
| `personal-class-source.svg` | 个人班级来源 | 本页面 | 页面专用 SVG |
