...
export const teacherTypographySemantic = {
  minimum: 500,
  regular: 500,
  semibold: 600,
  bold: 700,
...
export const teacherBrandCssVariables = {
  ...
  '--tm-compact-remove-control-size': '32px',
  '--tm-compact-remove-visible-size': '24px',
  '--tm-compact-remove-hit-slop': '6px',
  '--tm-compact-remove-corner-offset': '9px',
  '--tm-compact-remove-icon-size': '12px',
  '--tm-compact-remove-bg': 'var(--tm-status-negative)',
  '--tm-compact-remove-icon': 'var(--tm-text-inverse)',
  '--tm-compact-remove-pressed-bg': 'var(--tm-status-negative-strong)',
  ...
  '--tm-indicator-canvas-bg': teacherBrandSemantic.page,
  '--tm-indicator-canvas-root-bg': teacherBrandSemantic.primary,
  '--tm-indicator-canvas-root-text': teacherBrandSemantic.surface,
  '--tm-indicator-canvas-node-bg': teacherBrandSemantic.surface,
  '--tm-indicator-canvas-level-one-active-bg': teacherBrandSemantic.primarySoft,
  '--tm-indicator-canvas-level-two-bg': teacherBrandSemantic.surfaceSoft,
  '--tm-indicator-canvas-level-two-active-bg': teacherBrandSemantic.surfaceMuted,
  '--tm-indicator-canvas-leaf-bg': teacherBrandSemantic.surface,
  '--tm-indicator-canvas-toolbar-bg': teacherBrandSemantic.surfaceGlass,
  '--tm-indicator-canvas-branch-1': teacherReportChartSemantic.indicators[0],
  '--tm-indicator-canvas-branch-2': teacherReportChartSemantic.indicators[1],
  '--tm-indicator-canvas-branch-3': teacherReportChartSemantic.indicators[2],
  '--tm-indicator-canvas-branch-4': teacherReportChartSemantic.indicators[3],
  '--tm-indicator-canvas-branch-5': teacherReportChartSemantic.indicators[4],
  '--tm-indicator-canvas-branch-6': teacherReportChartSemantic.indicators[5],
  ...
  '--tm-class-list-leaderboard-touch-width': '120px',
  '--tm-class-list-leaderboard-touch-height': 'var(--tm-size-touch)',
  '--tm-class-list-leaderboard-image-width': '112px',
  '--tm-class-list-leaderboard-image-height': '24px',
  ...
  '--tm-indicator-canvas-root-width': `${teacherIndicatorCanvasMetrics.rootWidth}px`,
  '--tm-indicator-canvas-root-height': `${teacherIndicatorCanvasMetrics.rootHeight}px`,
  '--tm-indicator-canvas-level-one-width': `${teacherIndicatorCanvasMetrics.levelOneWidth}px`,
  '--tm-indicator-canvas-level-one-height': `${teacherIndicatorCanvasMetrics.levelOneHeight}px`,
  '--tm-indicator-canvas-level-two-width': `${teacherIndicatorCanvasMetrics.levelTwoWidth}px`,
  '--tm-indicator-canvas-level-two-height': `${teacherIndicatorCanvasMetrics.levelTwoHeight}px`,
  '--tm-indicator-canvas-leaf-group-width': `${teacherIndicatorCanvasMetrics.leafGroupWidth}px`,
  '--tm-indicator-canvas-leaf-height': `${teacherIndicatorCanvasMetrics.leafHeight}px`,
  '--tm-indicator-canvas-leaf-gap': `${teacherIndicatorCanvasMetrics.leafGap}px`,
  '--tm-indicator-canvas-leaf-radius': '8px',
  '--tm-indicator-canvas-icon-size': '18px',
  '--tm-indicator-canvas-root-font-size': '15px',
  '--tm-indicator-canvas-level-one-font-size': '16px',
  '--tm-indicator-canvas-level-two-font-size': '14px',
  '--tm-indicator-canvas-leaf-font-size': '14px',
  ...
  '--tm-font-weight-minimum': `${teacherTypographySemantic.minimum}`,
  '--tm-font-weight-regular': `${teacherTypographySemantic.regular}`,
  '--tm-font-weight-semibold': `${teacherTypographySemantic.semibold}`,
  '--tm-font-weight-bold': `${teacherTypographySemantic.bold}`,
  '--tm-font-weight-heavy': `${teacherTypographySemantic.heavy}`,
  ...
  '--tm-selection-segment-track-radius': 'var(--tm-radius-control)',
  '--tm-selection-segment-active-radius': 'calc(var(--tm-radius-control) - var(--tm-space-1))',
  ...
  '--tm-choice-pill-default-pressed-bg': 'var(--tm-choice-pill-default-bg)',
...
export const phoneText = {
  ...
  itemTitle: 'text-[15px] tm-font-regular leading-snug',
  body: 'text-[14px] font-medium leading-relaxed',
  helper: 'text-[12px] tm-font-regular leading-snug',
