    ...
    if (variant === 'student-detail') {
        return (
            <div className="absolute inset-0 overflow-hidden bg-[var(--tm-page-plain-content-bg)]" aria-hidden="true">
                <div className="absolute inset-x-0 top-0 h-[var(--tm-student-detail-header-height)] bg-[linear-gradient(135deg,var(--tm-bg-surface-soft)_0%,var(--tm-brand-primary-soft)_100%)]" />
