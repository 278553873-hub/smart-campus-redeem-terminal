...
for (const required of [
  ...
  'rounded-[var(--tm-selection-segment-active-radius)]',
  'text-[length:var(--tm-selection-segment-compact-font-size)]',
  'inset-x-0',
  ...
  '[transition-timing-function:var(--tm-selection-segment-slide-easing)]',
