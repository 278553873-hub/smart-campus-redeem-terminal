...
export const CLASS_EVALUATION_WEEKS: ClassEvaluationWeek[] = [
    {
        id: '2026-07-14_2026-07-20',
        start: '2026-07-14',
        end: '2026-07-20',
        label: '7月14日-7月20日',
        status: 'in_progress',
        snapshotLabel: '截至7月18日 16:36',
        dimensionRankings: [
...
export const CLASS_EVALUATION_RECORDS: ClassEvaluationRecord[] = [
    {
        id: 'CE-20260718-001', classId: 'c_2025_4', date: '2026-07-18', dimension: '健体班级', indicator: '早操精神风貌',
    ...
    {
        id: 'CE-20260718-002', classId: 'c_2025_4', date: '2026-07-18', dimension: '美净班级', indicator: '午检卫生',
    ...
    {
        id: 'CE-20260717-001', classId: 'c_2025_4', date: '2026-07-17', dimension: '文雅班级', indicator: '路队放学',
    ...
    {
        id: 'CE-20260715-001', classId: 'c_2025_4', date: '2026-07-15', dimension: '健体班级', indicator: '眼操教师组织',
    ...
    {
        id: 'CE-20260718-004', classId: 'c_2025_4', date: '2026-07-18', dimension: '美净班级', indicator: '公区保洁',
    ...
    {
        id: 'CE-20260718-005', classId: 'c_2025_4', date: '2026-07-18', dimension: '文雅班级', indicator: '图书管理',
    ...
    {
        id: 'CE-20260716-001', classId: 'c_2025_4', date: '2026-07-16', dimension: '美净班级', indicator: '晨检用具',
    ...
    {
        id: 'CE-20260718-003', classId: 'c_2025_4', date: '2026-07-18', dimension: '健体班级', indicator: '早操教师到岗',
    ...
    {
        id: 'CE-20260712-001', classId: 'c_2025_4', date: '2026-07-12', dimension: '诗意中队', indicator: '班级文化',
    ...
    {
        id: 'CE-20260711-001', classId: 'c_2025_4', date: '2026-07-11', dimension: '安全教育', indicator: '课间安全',
    ...
    {
        id: 'CE-20260710-001', classId: 'c_2025_4', date: '2026-07-10', dimension: '安全教育', indicator: '安全教育记录',
    ...
    {
        id: 'CE-20260709-001', classId: 'c_2025_4', date: '2026-07-09', dimension: '健体班级', indicator: '眼操动作',
    ...
    {
        id: 'CE-20260708-001', classId: 'c_2025_4', date: '2026-07-08', dimension: '文雅班级', indicator: '文明用语',
    ...
    {
        id: 'CE-20260707-001', classId: 'c_2025_4', date: '2026-07-07', dimension: '文雅班级', indicator: '路队秩序',
    ...
    {
        id: 'CE-20260707-002', classId: 'c_2025_4', date: '2026-07-07', dimension: '美净班级', indicator: '桌椅整齐',
    ...
    {
        id: 'CE-20260704-001', classId: 'c_2025_4', date: '2026-07-04', dimension: '诗意中队', indicator: '图书角管理',
    ...
    {
        id: 'CE-20260703-001', classId: 'c_2025_4', date: '2026-07-03', dimension: '健体班级', indicator: '早操队列',
    ...
    {
        id: 'CE-20260702-001', classId: 'c_2025_4', date: '2026-07-02', dimension: '健体班级', indicator: '眼操动作',
    ...
    {
        id: 'CE-20260701-001', classId: 'c_2025_4', date: '2026-07-01', dimension: '文雅班级', indicator: '课间礼仪',
    ...
    {
        id: 'CE-20260630-001', classId: 'c_2025_4', date: '2026-06-30', dimension: '美净班级', indicator: '晨检卫生',
    ...
    {
        id: 'CE-20260630-002', classId: 'c_2025_4', date: '2026-06-30', dimension: '美净班级', indicator: '用具归位',
