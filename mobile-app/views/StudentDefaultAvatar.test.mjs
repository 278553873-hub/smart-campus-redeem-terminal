...
const rosterCardSource = fs.readFileSync('mobile-app/components/student/StudentRosterCard.tsx', 'utf8');
...
assert.match(rosterCardSource, /student\.avatar \|\| \(student\.gender === 'female' \? ASSETS\.AVATAR\.STUDENT_GIRL_DEFAULT : undefined\)/);
