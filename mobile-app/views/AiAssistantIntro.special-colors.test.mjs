...
assert.match(tokens, /primary: teacherBrandPalette\.jade\[500\]/);
assert.match(tokens, /highlight: teacherBrandPalette\.jade\[300\]/);
...
assert.match(guidelines, /班主任助理使用玉石青角色 Token/);
