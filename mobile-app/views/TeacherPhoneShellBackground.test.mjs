...
requireText(appSource, 'return <TeacherMobileScreenBackground variant="me" />', '我的页面应使用方案八的专属弥散背景变体。');
requireText(backgroundSource, 'var(--tm-bg-page)', '公共背景组件应使用页面背景令牌。');
requireText(backgroundSource, 'var(--tm-me-gradient-base)', '我的页面专属背景应使用设计 Token。');
