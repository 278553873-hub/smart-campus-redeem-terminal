...
requireText("未绑定卡片展示学生头像、学生姓名和未绑定标签", '未绑定卡片应展示学生姓名和未绑定标签。');
...
requireText("班主任和管理员可以移除单个家长绑定关系", 'PRD 应说明班主任/管理员可移除绑定关系。');
...
if (parentBindingCardBlock.includes("'已绑定'")) {
  failures.push('家长绑定卡片不应重复展示已绑定标签。');
}
