...
const AdminMobileApp: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-[420px] h-[850px] mx-auto bg-slate-50 border-[8px] border-slate-900 rounded-[3rem] shadow-2xl relative overflow-hidden flex flex-col font-sans">
