...
requireText(parentSource, 'tabbar-jelly-active-', '家长端底部菜单应复刻教师端果冻回弹动效。');
requireText(parentSource, 'TeacherFluidGlassNav activeIndex={activeIndex} itemCount={tabItems.length} jellyToggle={parentNavJellyToggle}', '家长端底部菜单应使用教师端同款浅灰滑块和移动参数。');
