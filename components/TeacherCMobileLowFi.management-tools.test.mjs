...
requireText("modules: ['教师信息', '头像', '姓名', '扫一扫', '设置', '了解学校版', '管理工具', '生成期末报告', '更多工具', '学期管理', '科目管理', '部门管理', '货币发放管理'", '14A 应保留独立管理工具，并在更多工具中新增货币发放管理。');
requireText("modules: ['教师信息', '头像', '姓名', '扫一扫', '设置', '当前版本入口', '管理工具', '学校数据报表', '生成期末报告', '更多工具', '学期管理', '科目管理', '部门管理', '货币发放管理'", '14B 应保留独立管理工具，学校版展示学校数据报表，并在更多工具中保留货币发放管理。');
...
requirePrd('更多工具卡片 → 由原“学校基础信息”改名而来，14A 展示学期管理、科目管理、部门管理、货币发放管理', 'PRD 应说明 14A 更多工具内容。');
requirePrd('管理工具卡片 → 14B 当前切到学校版时展示学校数据报表、生成期末报告；切到个人版时仅展示生成期末报告', 'PRD 应说明 14B 管理工具随当前版本切换。');
requirePrd('更多工具卡片 → 由原“学校基础信息”改名而来，14B 展示学期管理、科目管理、部门管理、货币发放管理', 'PRD 应说明 14B 更多工具内容。');
