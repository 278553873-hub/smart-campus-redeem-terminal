...
requireText("modules: ['教师信息', '头像', '姓名', '扫一扫', '设置', '了解学校版', '管理工具', '期末报告', '更多工具', '科目管理', '部门管理', '货币发放管理'", '14A 应保留独立管理工具，并在更多工具中新增货币发放管理。');
requireText("modules: ['教师信息', '头像', '姓名', '扫一扫', '设置', '班级来源入口', '管理工具', '学校报表', '期末报告', '更多工具', '科目管理', '部门管理', '货币发放管理'", '14B 应保留独立管理工具，学校版展示学校报表，并在更多工具中保留货币发放管理。');
