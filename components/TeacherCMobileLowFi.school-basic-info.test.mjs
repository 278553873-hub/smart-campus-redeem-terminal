...
requireText("pages: ['minePersonal', 'teacherBasicInfoPersonal', 'suggestionFeedback']", '我的(个人版)流程应包含 14A、15A 和 22。');
requireText("pages: ['mineSchool', 'teacherBasicInfoSchool', 'mineSettings', 'subjectManagement', 'departmentManagement', 'coinIssuanceManagement', 'suggestionFeedback']", '我的(学校版)流程应包含 14B、15B、16、18、19、21、22。');
forbidText('<PageNodeButton item="termManagement" lane={lane.title} />', '14A/14B 已取消学期管理入口，页面导航图不应展示学期管理节点。');
...
requireText('<PageNodeButton item="suggestionFeedback" lane={lane.title} />', '页面导航图应展示建议反馈节点。');
...
requireText("const mineMoreToolTabs = schoolBasicInfoTabs.filter((item) => item.key !== 'term');", '我的页更多工具应过滤掉学期管理入口。');
