...
| 班级操作 | 班级卡片更多 | 作业录入、兑换奖励、批量修改学生、更新人脸数据、设置兑换密码、离校学生管理、邀请老师、邀请家长 |
...
| 采集与档案 | 采集管理、档案设计 | 新建或编辑表单、预览、发布、填写、答卷或采集详情；档案在填写完成后自动建立或更新 |
...
| --- | --- |
| 日常操作 | 作业录入、兑换奖励 |
| 学生管理 | 批量修改学生、更新人脸数据、设置兑换密码、离校学生管理 |
| 协同管理 | 邀请老师加入、邀请家长加入 |
...
- 更多工具：作业批量录入、货币发放、问卷采集、值周安排、家长端展示、档案设计、科目管理、部门管理、建议反馈；
- 固定底部导航。
