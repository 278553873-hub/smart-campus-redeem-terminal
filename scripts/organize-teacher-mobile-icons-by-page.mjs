...
const iconLabels = {
  ...
  'flask-conical.svg': '科学', 'folder.svg': '分组', 'folder-archive.svg': '批量留档',
...
const pageSpecificLabels = {
  '03-班级/班级列表': {
    ...
    'users.svg': '学生列表、批量修改、离校学生管理', 'folder-archive.svg': '批量留档',
  },
  '03-班级/班级更多操作': {
    'check.svg': '班级号复制成功', 'copy.svg': '复制班级号', 'file-text.svg': '作业录入',
    'folder-archive.svg': '批量留档', 'gift.svg': '兑换奖励', 'message-circle.svg': '邀请家长加入',
...
const pageDefinitions = [
  ...
  { folder: '07-AI助理/班主任助理', roots: ['mobile-app/views/AiHeadteacherAssistantView.tsx'], images: ['ai-headteacher-assistant-icon.png', 'ai-art-badge.png'] },
  { folder: '07-AI助理/班主任助理V2', roots: ['mobile-app/views/AiHeadteacherAssistantV2View.tsx'], images: ['ai-headteacher-assistant-icon.png', 'ai-art-badge.png'] },
