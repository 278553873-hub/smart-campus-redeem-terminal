...
const DISPLAY_CONFIGS: Record<ResolvedClassroomDisplayMode, ClassroomDisplayConfig> = {
  standard: {
    ...
    groupCard: { width: 280, gap: 12, compactHeight: 112, fullHeight: 120, avatarSize: 56, titleFontSize: 17, memberFontSize: 12, countFontSize: 10, countItemHeight: 18, countItemMinWidth: 24, countGap: 8 },
    memberSelect: { columnMinWidth: 82, gap: 8, minHeight: 96, avatarSize: 48, nameFontSize: 12 },
    ...
    evaluation: { modalWidth: 840, optionColumns: 5, optionGap: 16, optionHeight: 56, optionFontSize: 15, titleFontSize: 18, tabFontSize: 14, categoryFontSize: 13, managerColumns: 3, managerOptionHeight: 56, headerHeight: 72, headerPadding: 24, avatarSize: 44, avatarIconSize: 20, studentNoFontSize: 10, selectionHintFontSize: 12, managerHeight: 480, managerSidebarWidth: 200, managerHeaderFontSize: 11, managerRowHeight: 52, managerMetaFontSize: 10, managerControlSize: 24, closeButtonSize: 36, closeIconSize: 20, contentPadding: 32, categoryGap: 16 },
  ...
  classroom: {
    ...
    groupCard: { width: 320, gap: 16, compactHeight: 128, fullHeight: 140, avatarSize: 64, titleFontSize: 19, memberFontSize: 14, countFontSize: 12, countItemHeight: 20, countItemMinWidth: 28, countGap: 10 },
    memberSelect: { columnMinWidth: 96, gap: 12, minHeight: 112, avatarSize: 60, nameFontSize: 13 },
  ...
  distant: {
    ...
    groupCard: { width: 360, gap: 20, compactHeight: 148, fullHeight: 160, avatarSize: 72, titleFontSize: 21, memberFontSize: 16, countFontSize: 14, countItemHeight: 22, countItemMinWidth: 32, countGap: 12 },
    memberSelect: { columnMinWidth: 116, gap: 16, minHeight: 132, avatarSize: 72, nameFontSize: 14 },
    ...
    evaluation: { modalWidth: 1120, optionColumns: 4, optionGap: 20, optionHeight: 78, optionFontSize: 19, titleFontSize: 22, tabFontSize: 18, categoryFontSize: 17, managerColumns: 3, managerOptionHeight: 72, headerHeight: 104, headerPadding: 40, avatarSize: 60, avatarIconSize: 28, studentNoFontSize: 14, selectionHintFontSize: 16, managerHeight: 600, managerSidebarWidth: 280, managerHeaderFontSize: 15, managerRowHeight: 76, managerMetaFontSize: 14, managerControlSize: 40, closeButtonSize: 52, closeIconSize: 28, contentPadding: 48, categoryGap: 24 },
